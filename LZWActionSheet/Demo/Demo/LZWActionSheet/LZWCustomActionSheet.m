...
//        self.userInteractionEnabled = YES;
        ...
        self.backGroundView = [[UIView alloc] initWithFrame:CGRectMake(0, ([UIScreen mainScreen].bounds.size.height - height),[UIScreen mainScreen].bounds.size.width, height)];
